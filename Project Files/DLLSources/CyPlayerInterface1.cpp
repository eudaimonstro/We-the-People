...
void CyPlayerPythonInterface1(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("triggerEuropeanWarDemand", &CyPlayer::triggerEuropeanWarDemand, "bool (int eEnemyPlayer)")
		.def("modernizeRevolutionEuropeNavy", &CyPlayer::modernizeRevolutionEuropeNavy, "void ()")
